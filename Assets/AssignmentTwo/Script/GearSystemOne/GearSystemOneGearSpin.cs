...
// Controls the rotation of the gears in gear system one based on the previous gear's rotation.
public class GearSystemOneGearSpin : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (gearSpin)
        {
            transform.Rotate(-delta * gearRatio, 0f, 0f);
