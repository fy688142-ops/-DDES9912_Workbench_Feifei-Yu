...
// Controls the rotation of 24-tooth gear based on the previous gear's rotation.
public class Gear24ToothSpin : MonoBehaviour
{
    // Reference to the previous gear driving this one.
    public Gear6ToothSpin previousGear;
