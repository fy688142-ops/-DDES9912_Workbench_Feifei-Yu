...
// Controls the rotation of 8-tooth gear based on the previous gear's rotation.
public class Gear8ToothSpin : MonoBehaviour
{
    // Reference to the previous gear driving this one.
    public GearSystemOneGearSpin previousGear;
    // Multiplier controlling rotation speed relative to previous gear.
    public float gearRatio = 5.75f;
